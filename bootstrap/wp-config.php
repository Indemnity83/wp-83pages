...
// WP Read-Only
define('WPRO_ON', $_ENV["WPRO_ON"]);
define('WPRO_SERVICE', 's3');
define('WPRO_FOLDER', $_ENV["WPRO_FOLDER"]);
define('WPRO_AWS_KEY', $_ENV["AWS_S3_KEY"]);
define('WPRO_AWS_SECRET', $_ENV["AWS_S3_SECRET"]);
define('WPRO_AWS_BUCKET', $_ENV["AWS_S3_BUCKET"]);
define('WPRO_AWS_VIRTHOST', $_ENV["AWS_S3_VIRT_HOST"]);
define('WPRO_AWS_ENDPOINT', $_ENV["AWS_S3_ENDPOINT"]);
